...
@RoutePage<void>()
class StreetLightComponentCompletScreen extends StatefulWidget {
  final StoreStreetLightResponseComplet? streetLight;
  final MissionResponse? mission;
  final String source;
  final String? networkLabel;

  const StreetLightComponentCompletScreen(
      {super.key,
      this.streetLight,
      this.mission,
  ...
  @override
  State<StreetLightComponentCompletScreen> createState() => StreetLightComponentCompletScreenState();

}

class StreetLightComponentCompletScreenState extends State<StreetLightComponentCompletScreen> {
     @override
        ...
        slivers: [
          SliverAppBar(
            ...
            actions: [
              ...
              //           intention: "update",
              //           existingStreetLight:
              //               widget.streetLight, // Passer les données existantes
              //         ),
              //       );
              //     },
                ...
                children: [
                    ...
                    children: [
                      ...
                      _buildInfoCard(
                        ...
                        children: [
                          ...
                          CustomListTitle(
                            title: "Localisation :",
                            value: widget.streetLight?.street ?? 'Non renseigné',
                            valueStyle: defaultTextStyle,
                          ),
                          const Divider(height: 8, thickness: 0.5),
                          CustomListTitle(
                            title: "Commune :",
                            value: widget.streetLight?.municipality ??
                                'Non renseigné',
                            valueStyle: defaultTextStyle,
                          ),
                          const Divider(height: 8, thickness: 0.5),
                          ...
                          CustomListTitle(
                            ...
                            value: widget.streetLight?.supportType ??
                                'Non renseigné',
                            valueStyle: defaultTextStyle,
                          ),
                          const Divider(height: 8, thickness: 0.5),
                          CustomListTitle(
                            ...
                            value: widget.streetLight?.supportCondition ??
                                'Non renseigné',
                            valueStyle: defaultTextStyle,
                          ),
                          const Divider(height: 8, thickness: 0.5),
                          CustomListTitle(
                            title: "Orientation :",
                            value: widget.streetLight?.orientation ??
                                'Non renseigné',
                            valueStyle: defaultTextStyle,
                          ),
                          const Divider(height: 8, thickness: 0.5),
                          CustomListTitle(
                            ...
                            value:
                                widget.streetLight?.network ?? 'Non renseigné',
                            valueStyle: defaultTextStyle,
                          ),
                          const Divider(height: 8, thickness: 0.5),
                          CustomListTitle(
                            title: "Type de lampadaire :",
                            value: widget.streetLight?.streetLightType ??
                                'Non renseigné',
                            valueStyle: defaultTextStyle,
                          ),
                          const Divider(height: 8, thickness: 0.5),
                  ...
                  if (widget.streetLight?.cabinet != null) ...[
                    ...
                    _buildEquipmentSectionPortrait(
                      ...
                      //imageAsset: widget.streetLight?.cabinet?.photo ?? Assets.armoire,
                      defaultTextStyle: defaultTextStyle,
                      highlightedTextStyle: highlightedTextStyle,
                    ),
                  ],
